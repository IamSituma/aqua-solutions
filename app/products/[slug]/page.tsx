            ...
            <div className="flex flex-col">
              ...
              <div className="grid grid-cols-2 sm:flex sm:flex-row items-stretch sm:items-center gap-3 mt-auto pt-6 border-t border-gray-200">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 bg-white hover:bg-[#0077b6] border border-gray-300 hover:border-[#0077b6] text-black hover:text-white text-sm font-semibold px-6 py-3 rounded-md transition-colors"
                >
